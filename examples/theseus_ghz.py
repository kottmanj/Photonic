...
# Normalized Fidelity
E1 = tq.ExpectationValue(U=U1+U2, H=H)
# CountRate
E2 = tq.ExpectationValue(U=U1,H=P1) 
...
print(U1+U2)
U = tq.compile(U1+U2, backend="cirq").abstract_circuit
tq.circuit.export_to(U,"full_circuit_compiled_to_cirq.pdf")
U = tq.compile(U1+U2, backend="qulacs").abstract_circuit
